...
#define CONFIG_INS_TYPE 				HAL_INS_DEFAULT  // HAL_INS_OILPAN
#define CONFIG_BARO     				HAL_BARO_DEFAULT  //HAL_BARO_BMP085
#define CONFIG_COMPASS 					HAL_Compass_QMC5883L  //------------>>>>>>>>    HAL_COMPASS_DEFAULT
...
// expected magnetic field strength.  pre-arm checks will fail if 50% higher or lower than this value
 ...
 #endif  //COMPASS_MAGFIELD_EXPECTED ->mavlink_compassmot [\compassmot.pde]->handleMessage[\GCS_Mavlink.pde]
         //                          ->pre_arm_checks[\motors.pde]->one_hz_loop[\ArduCopter.pde]
		 //                          ->pre_arm_checks[\motors.pde]->handleMessage[\GCS_Mavlink.pde]
		 //							 ->arm_motors_check[\motors.pde]->scheduler_tasks[\ArduCopter.pde]
#else // PX4, SITL
 #ifndef  COMPASS_MAGFIELD_EXPECTED
